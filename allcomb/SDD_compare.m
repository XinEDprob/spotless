%% to compare the optimization on SDD matrices and SDD tensors induced polynomials

%% Optimization on SDD matrices induced polynomials
...
prog = prog.withSDSOS(p - gamma * diagonal);
